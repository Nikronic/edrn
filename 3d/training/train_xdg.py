...
checkpoint_path = 'logs/weights/ff/4932098/4932098_iter2996.pt'  # TODO
...
epoch_sizes = multires_utils.prepare_epoch_sizes(n_resolutions=len(resolutions), # TODO
                                                 start=800, end=1500, 
                                                 mode=epoch_mode, constant_value=5000)  # TODO
...
for idx, res in enumerate(resolutions):
    ...
    ckp_step = epoch_sizes[idx] // 100  # TODO
    # training of xPhys
    for step in tqdm(range(init_step, epoch_sizes[idx]), desc='Training: '):
        ...
        with torch.no_grad():
            ...
            # TODO add saving image for vis here too
